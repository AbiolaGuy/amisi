...
public class Note {
    ...
    JPanel inside = new JPanel(new GridLayout(10,1,2,6));
    ...
    void Notepad(){
        ...
        jTextField.setPreferredSize(new Dimension(800,35));
        //jTextField.setText("Write something..................?");

        area.setSize(600,200);
